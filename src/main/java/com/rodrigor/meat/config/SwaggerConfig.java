...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.rodrigor.meat.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("MEAT API",
				"Esta API é utilizada no projeto MEAT", "Versão 1.0",
				"https://www.udemy.com/terms",
				new Contact("RodrigoRibeiro", "https://github.com/RodrigoRibeiroSilva","rodrigo94.ribeiro.silva@gmail.com"),
